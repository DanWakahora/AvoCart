		...
		<section>
			...
			<div id="sectionDiv2">
				<blockquote>
					...
					<dl id="dlIndexPage">
						<dt>
							<b>AvoCart proudly serves a wide range of delivery destinations to ensure our fresh, high-quality avocados reach as many customers as possible. 
						We currently deliver to the following regions:</b>
						</dt>
						<br>
						<table id="table">
							<thead>
