	...
	<body>
		...
		<section>
			<div id="sectionDiv1">
				...
				<h3 style="color: #848B79;">AvoCart proudly serves a wide range of dedicated clients across our different delivery destinations. Check out the summary below:</h3>
			</div>
			<div id="sectionDiv2">
				<blockquote>
					<!-- Inline CSS (not encouraged - it is only placed here for demo purposes) -->
